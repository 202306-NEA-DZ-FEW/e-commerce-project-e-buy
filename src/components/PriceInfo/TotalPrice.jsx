...
const TotalPrice = () => {
  ...
  return (
    <div className=" flex justify-evenly flex-col mt-1 h-auto rounded-lg border bg-gray-50 p-6 shadow-md md:mt-0 md:w-1/3">
      ...
      <div>
        <Link
          href="checkout"
          className="w-full flex justify-center group relative overflow-hidden mt-6 rounded-md  py-2 font-medium bg-EBuyYellow text-white "
        >
          Proceed to Checkout
