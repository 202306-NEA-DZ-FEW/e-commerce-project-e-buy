...
const Item = ({
  ...
  return (
    <div className="justify-between my-2 rounded-lg bg-gray-50 p-5 shadow-md sm:flex sm:justify-start">
      <Image
        src={thumbnail}
        alt={description}
        width={100}
      ...
      <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between ">
        ...
        <div className="mt-4 flex justify-between im sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
          <div className="flex items-center justify-end border-gray-100 ">
            ...
            <input
              className="h-8 w-8 border bg-gray-50 text-center text-xs outline-none"
              value={itemCout}
              min="1"
              readOnly
            />
